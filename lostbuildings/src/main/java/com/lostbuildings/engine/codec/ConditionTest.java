...
/**
 * Represents a condition (a set of tests) attached to a part reference or a mob/loot selector.
 */
public class ConditionTest {
    ...
    public static final Codec<Either<List<String>, String>> LIST_OR_STRING_CODEC =
            Codec.either(Codec.list(Codec.STRING), Codec.STRING);
    ...
    protected static Optional<Set<String>> convertSetOrString(Optional<Either<List<String>, String>> either) {
        ...
        return Optional.ofNullable(either.get().map(Set::copyOf, Set::of));
    }
}
