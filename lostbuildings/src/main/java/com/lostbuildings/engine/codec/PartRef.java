...
/**
 * In a building this represents a reference to a building part together with conditions that
 * indicate where the part can be used.
 */
public class PartRef extends ConditionTest {
    ...
    public PartRef(String part,
        ...
        super(top, ground, cellar, isbuilding, issphere, floor, chunkx, chunkz,
                convertSetOrString(belowpart), convertSetOrString(inpart),
