# [SUPERSEDED] → см. `../PORT-PLAN-26.2.md`

> Этот файл устарел. Актуальный план порта (проверенные факты, агенты A–D, автономный
> луп оркестратора, token-economy) — **`../PORT-PLAN-26.2.md`** (в корне репозитория).
> Ниже — исходный черновик.
